...
let shop = [
	...
	['Custom Color', 'Changes the color of your name (can be denied)', 20],
	['POTD', 'Allows you to change the Pokemon of the Day that shows up guaranteed in Random Battles (can be refused, or held off if one is already active)', 20],
	...
	['Custom Emoticon', 'You provide an image (50x50) to be added as an emote on the server. (Can be refused)', 30],
	['Profile Help', 'Staff members will help you set your profile. (responses may not be immediate)', 35],
